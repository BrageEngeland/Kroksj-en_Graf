...
def plot_live_data(smoothing_method='moving_average', hours_back=None, daytime_only=False, moving_average_window=5):
    ...
    ax1.plot(tidspunkter_smooth, vindhastighet_smooth, 'b-', label='Vindhastighet (m/s)')
    ax1.set_xlabel('Tid')
    ax1.set_ylabel('Vindhastighet (m/s)', color='b')
    ax1.tick_params(axis='y', labelcolor='b')

    ax2 = ax1.twinx()
    ax2.plot(tidspunkter_smooth, temperatur_smooth, 'r-', label='Temperatur (°C)')
